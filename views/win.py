...
class WinView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(f"Счет: {self.score} | Время: {self.final_time}с", constants.SCREEN_WIDTH / 2, 350,
                         arcade.color.WHITE, 20, anchor_x="center")

        # Текст подсказки
        hint = "Нажми ENTER, чтобы идти дальше" if self.current_level < 2 else "Ты прошел всю игру! Нажми ENTER для меню"
        arcade.draw_text(hint, constants.SCREEN_WIDTH / 2, 200, arcade.color.GRAY, 16, anchor_x="center")
